...
- [Permit.io](https://permit.io) - An authorization as a service solution that allows building and managing authorization in Next.js, supporting RBAC, ABAC, and ReBAC with a no-code UI.
